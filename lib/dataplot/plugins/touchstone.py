...
class touchstone():
    ...
    def get_sparameter_arrays(self):
        ...
        # this return is tricky,  its due the stupid way the touchtone lines are in order like s11,s21, etc.
        # Because of this we need the transpose command, and axes specifier
